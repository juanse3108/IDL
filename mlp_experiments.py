...
os.makedirs("results_MLP/plots", exist_ok=True)

# Function to build MLP model with given parameters
def build_mlp(
    input_shape=(28, 28),
    activation='relu',
    optimizer='sgd',
...
for activation, optimizer, dropout_rate, l1_reg, l2_reg in param_combinations:
    ...
    plot_filename = f"results_MLP/plots/run_{run_id}_acc_plot.png"
...
csv_path = f"results_MLP/mlp_experiments_{timestamp}.csv"
